    ...
    <div className="min-h-screen flex items-center justify-center px-4 hero-gradient">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Entrar na ArtCamp</h1>
          <p className="text-white/40 mt-1">Acesse sua conta para continuar</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? "text" : "password"} placeholder="sua senha" className="pl-9 pr-9" value={password} onChange={(e) => setPassword(e.target.value)} />
          ...
          <p className="text-center text-sm text-white/40">
            Não tem conta? <Link href="/register" className="text-violet-400 hover:text-violet-300">Cadastre-se</Link>
          </p>
        </div>
      </div>
    </div>
