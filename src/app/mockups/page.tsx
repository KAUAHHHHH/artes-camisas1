    ...
    <div className="pt-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          <Badge variant="default" className="mb-4">MOCKUPS</Badge>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            <span className="gradient-text">Packs</span> de Mockups
          </h1>
          <p className="text-white/40 max-w-2xl mx-auto">
            Packs de mockups profissionais em CDR, PSD e PNG. Prontos para personalizar e apresentar seus designs.
          </p>
        </div>
              ...
              <div key={product.id} className="glass-card rounded-2xl overflow-hidden group">
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-xs text-white/40">Mockup</span>
